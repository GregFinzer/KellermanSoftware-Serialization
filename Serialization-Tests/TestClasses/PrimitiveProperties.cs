...
namespace SerializationTests.TestClasses
{
    ...
    public class PrimitiveProperties
    {
        ...
        {
            BooleanPropertyStatic = false;
            BytePropertyStatic = 0;
            SBytePropertyStatic = 0;
            IntMaxPropertyStatic = 0;
            IntMinPropertyStatic = 0;
            LongMaxPropertyStatic = 0;
            LongMinPropertyStatic = 0;
            Int16PropertyStatic = 0;
            UInt16PropertyStatic = 0;
            Int32PropertyStatic = 0;
            UInt32PropertyStatic = 0;
            Int64PropertyStatic = 0;
            UInt64PropertyStatic = 0;
            CharPropertyStatic = '0';
            DoublePropertyStatic = 0;
            FloatPropertyStatic = 0;
